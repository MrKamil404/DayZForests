...
const DICT: &[Entry] = &[
    ...
    ("Pniaki i wykroty", "Stumps and fallen trunks", "Stümpfe und Windbruch"),
    ("Buk — pniaki i wykroty", "Beech — stumps and fallen trunks", "Buche — Stümpfe und Windbruch"),
    ("Dąb — pniaki i wykroty", "Oak — stumps and fallen trunks", "Eiche — Stümpfe und Windbruch"),
    ("Sosna — pniaki i wykroty", "Pine — stumps and fallen trunks", "Kiefer — Stümpfe und Windbruch"),
    ("Świerk — pniaki i wykroty", "Spruce — stumps and fallen trunks", "Fichte — Stümpfe und Windbruch"),
    ("Brzoza — pniaki i wykroty", "Birch — stumps and fallen trunks", "Birke — Stümpfe und Windbruch"),
    ("Świerk mroczny — pniaki i wykroty", "Dark spruce — stumps and fallen trunks", "Dunkle Fichte — Stümpfe und Windbruch"),
    ("Świerk zimowy — pniaki i wykroty", "Winter spruce — stumps and fallen trunks", "Winter-Fichte — Stümpfe und Windbruch"),
    ("Brzoza zimowa — pniaki i wykroty", "Winter birch — stumps and fallen trunks", "Winter-Birke — Stümpfe und Windbruch"),
    ("Brzoza jesienna — pniaki i wykroty", "Autumn birch — stumps and fallen trunks", "Herbst-Birke — Stümpfe und Windbruch"),
    ("Żywopłot liściasty", "Deciduous hedgerow", "Laubhecke"),
    ("Podszyt — samosiewy", "Undergrowth — self-seeding", "Unterwuchs — Naturverjüngung"),
    ("Ciernisty pas", "Thorny belt", "Dornengürtel"),
    ("Zimowy pas krzewów", "Winter shrub belt", "Winter-Strauchgürtel"),
    (
        "Miks presetów (zastępuje ręczną listę):",
        "Preset mix (replaces the manual list):",
        "Preset-Mix (ersetzt die manuelle Liste):",
    ),
    ("Buk (wykrot)", "Beech (fallen)", "Buche (liegend)"),
    ("Buk (wykrot B)", "Beech (fallen B)", "Buche (liegend B)"),
    ("Buk (wykrot C)", "Beech (fallen C)", "Buche (liegend C)"),
    ("Buk (pniak)", "Beech (stump)", "Buche (Stumpf)"),
    ("Buk (pniak B)", "Beech (stump B)", "Buche (Stumpf B)"),
    ("Buk (pniak C)", "Beech (stump C)", "Buche (Stumpf C)"),
    ("Dąb (wykrot B)", "Oak (fallen B)", "Eiche (liegend B)"),
    ("Dąb (wykrot C)", "Oak (fallen C)", "Eiche (liegend C)"),
    ("Dąb (pniak)", "Oak (stump)", "Eiche (Stumpf)"),
    ("Dąb (pniak B)", "Oak (stump B)", "Eiche (Stumpf B)"),
    ("Brzoza (wykrot)", "Birch (fallen)", "Birke (liegend)"),
    ("Brzoza (pniak)", "Birch (stump)", "Birke (Stumpf)"),
    ("Sosna (wykrot)", "Pine (fallen)", "Kiefer (liegend)"),
    ("Sosna (wykrot B)", "Pine (fallen B)", "Kiefer (liegend B)"),
    ("Sosna (wykrot C)", "Pine (fallen C)", "Kiefer (liegend C)"),
    ("Sosna (pniak)", "Pine (stump)", "Kiefer (Stumpf)"),
    ("Sosna (pniak B)", "Pine (stump B)", "Kiefer (Stumpf B)"),
    ("Świerk (wykrot)", "Spruce (fallen)", "Fichte (liegend)"),
    ("Świerk (wykrot B)", "Spruce (fallen B)", "Fichte (liegend B)"),
    ("Świerk (wykrot C)", "Spruce (fallen C)", "Fichte (liegend C)"),
    ("Świerk (wykrot D)", "Spruce (fallen D)", "Fichte (liegend D)"),
    ("Świerk (wykrot E)", "Spruce (fallen E)", "Fichte (liegend E)"),
    ("Świerk (pniak)", "Spruce (stump)", "Fichte (Stumpf)"),
    ("Świerk (pniak B)", "Spruce (stump B)", "Fichte (Stumpf B)"),
    ("Świerk (pniak C)", "Spruce (stump C)", "Fichte (Stumpf C)"),
    ("Świerk (pniak D)", "Spruce (stump D)", "Fichte (Stumpf D)"),
    ("Świerk (wykrot, mrok)", "Spruce (fallen, dark)", "Fichte (liegend, dunkel)"),
    ("Świerk (wykrot B, mrok)", "Spruce (fallen B, dark)", "Fichte (liegend B, dunkel)"),
    ("Świerk (wykrot C, mrok)", "Spruce (fallen C, dark)", "Fichte (liegend C, dunkel)"),
    ("Świerk (wykrot D, mrok)", "Spruce (fallen D, dark)", "Fichte (liegend D, dunkel)"),
    ("Świerk (wykrot E, mrok)", "Spruce (fallen E, dark)", "Fichte (liegend E, dunkel)"),
    ("Świerk (pniak, mrok)", "Spruce (stump, dark)", "Fichte (Stumpf, dunkel)"),
    ("Świerk (pniak B, mrok)", "Spruce (stump B, dark)", "Fichte (Stumpf B, dunkel)"),
    ("Świerk (pniak C, mrok)", "Spruce (stump C, dark)", "Fichte (Stumpf C, dunkel)"),
    ("Świerk (wykrot, zima)", "Spruce (fallen, winter)", "Fichte (liegend, Winter)"),
    ("Świerk (wykrot B, zima)", "Spruce (fallen B, winter)", "Fichte (liegend B, Winter)"),
    ("Świerk (wykrot C, zima)", "Spruce (fallen C, winter)", "Fichte (liegend C, Winter)"),
    ("Świerk (wykrot D, zima)", "Spruce (fallen D, winter)", "Fichte (liegend D, Winter)"),
    ("Świerk (wykrot E, zima)", "Spruce (fallen E, winter)", "Fichte (liegend E, Winter)"),
    ("Świerk (pniak, zima)", "Spruce (stump, winter)", "Fichte (Stumpf, Winter)"),
    ("Świerk (pniak B, zima)", "Spruce (stump B, winter)", "Fichte (Stumpf B, Winter)"),
    ("Świerk (pniak C, zima)", "Spruce (stump C, winter)", "Fichte (Stumpf C, Winter)"),
    ("Brzoza (wykrot, jesień)", "Birch (fallen, autumn)", "Birke (liegend, Herbst)"),
    ("Brzoza (pniak, jesień)", "Birch (stump, autumn)", "Birke (Stumpf, Herbst)"),
    ("Brzoza (wykrot, zima)", "Birch (fallen, winter)", "Birke (liegend, Winter)"),
    ("Brzoza (pniak, zima)", "Birch (stump, winter)", "Birke (Stumpf, Winter)"),
    // --- nowe etykiety UI ---
